...
//  TodoList
//
//  Created by Usama Jamil on 19/07/2019.
...
extension UIWindow {
    ...
    func switchRootViewController(_ viewController: UIViewController,  animated: Bool = true, duration: TimeInterval = 0.5, options: UIView.AnimationOptions = .preferredFramesPerSecond60, completion: (() -> Void)? = nil) {
        guard animated else {
...
public extension UIWindow {
    ...
    func setRootViewController(_ controller: UIViewController, options: TransitionOptions = TransitionOptions()) {
        ...
        self.rootViewController = UINavigationController.init(rootViewController: controller)
